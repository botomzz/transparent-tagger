...
interrogators: Dict[str, Interrogator] = {
    ...
    'z3d-e621-convnext-pugliathomas': WaifuDiffusionInterrogator(
        'Z3D-E621-Convnext(pugliathomas)',
        repo_id='pugliathomas/Z3D-E621-Convnext',
        tags_path='tags-selected.csv'
    ),
    ...
    'wd-vit-large-tagger-v3-q8': WaifuDiffusionInterrogator(
        'wd-vit-large-tagger-v3-q8',
        repo_id='bn22/wd-vit-large-tagger-v3-q8',
        model_path='model-quant-int8.onnx',
        tags_path='selected_tags.csv'
    ),
    'wd-vit-tagger-v3': WaifuDiffusionInterrogator(
        'wd-vit-tagger-v3',
        repo_id='ura23/wd-vit-tagger-v3',
        model_path='model.onnx',
        tags_path='selected_tags.csv'
    ),
    'wd-swinv2-tagger-v3-quint8': WaifuDiffusionInterrogator(
        'wd-swinv2-tagger-v3-quint8',
        repo_id='KidiXDev/wd-swinv2-tagger-v3-quint8',
        model_path='model.onnx',
        tags_path='selected_tags.csv'
    ),
